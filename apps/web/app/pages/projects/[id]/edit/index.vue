<script setup lang="ts">
    /**
     * TODO: Default values are not properly inserted here
     * Seems like a hydration issue, since, first, the middleware evaluates
     * that the `project` exists, and then, tries to query that data again
     * in the page.
     *
     * The <Input /> elements are mounted first, so, the first value
     * they get is undefined, since the request hasn't been completed yet.
     *
     */
